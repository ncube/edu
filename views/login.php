                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <form action="<?=$data['registerAction']?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-warning btn-lg pull-md-right">Register</button>
                                </div>
                            </form>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-md-offset-1 push-top">
                                ...
                                <form method="post" action="<?=$data['loginAction']?>">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="token" value="<?=$data['token']?>">
                                        <button type="submit" class="btn btn-secondary btn-lg pull-md-right">Log In</button>
                                    </div>
                                </form>
                            </div>
                        </div>
